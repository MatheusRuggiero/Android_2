...
import br.com.tecnomotor.marvin.utils.constant.URL.INJECTOR_PLATFORM
...
interface InjectorPlatformLotXidInterface {
    @Headers("Content-Type:application/octet-stream")
    @GET(CRMANAGER + SEPARATOR + API + SEPARATOR + ANDROID + SEPARATOR + V_1 + SEPARATOR + INJECTOR_PLATFORM + SEPARATOR + LOT_XID)
    fun getLotXid(@QueryMap params: Map<String, String>): Call<List<InjectorPlatformSynchronize>>
}