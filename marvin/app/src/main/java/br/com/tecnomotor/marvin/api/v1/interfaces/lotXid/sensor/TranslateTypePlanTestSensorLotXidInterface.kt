...
import br.com.tecnomotor.marvin.utils.constant.URL.TRANSLATE_TYPE_PLAN_TEST_SENSOR
...
interface TranslateTypePlanTestSensorLotXidInterface {
    @Headers("Content-Type:application/octet-stream")
    @GET(CRMANAGER + SEPARATOR + API + SEPARATOR + ANDROID + SEPARATOR + V_1 + SEPARATOR + TRANSLATE_TYPE_PLAN_TEST_SENSOR + SEPARATOR + LOT_XID)
    fun getLotXid(@QueryMap params: Map<String, String>): Call<List<TranslateTypePlanTestSensorSynchronize>>
}