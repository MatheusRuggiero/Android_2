...
import br.com.tecnomotor.marvin.api.v1.controller.maxXid.global.TypePlanTestMaxXidController
import br.com.tecnomotor.marvin.api.v1.interfaces.maxXid.injector.TranslateTypePointTestInjectorMaxXidInterface
...
class TranslateTypePointTestInjectorMaxXidController(
            ...
            if (txtViewMessageProgress != null) {
                activity?.runOnUiThread {
                    txtViewMessageProgress!!.text =
                        application.applicationContext.getString(R.string.max_xid_translate_type_point_test_injector)
                    btnStartSynchronization!!.isEnabled = false
                }
                isSynchronizationBackground = false
            }

            val call = BasicAuthClientDefault<TranslateTypePointTestInjectorMaxXidInterface>(
                mobileUser.userName!!,
                mobileUser.password!!,
                application.applicationContext
            )
                .create(TranslateTypePointTestInjectorMaxXidInterface::class.java)
                .getMax(params)
                        ...
                        GlobalScope.launch(Dispatchers.IO) {
                            ...
                            if (valuesMaxXid != null
                                ...
                                if (!isSynchronizationBackground) {
                                    GlobalUtil.method.shortTimeMessageAlert(
                                        application.applicationContext,
                                        application.applicationContext.getString(R.string.not_values_translate_type_point_test_injector_max_xid)
                                    )
                                }
                            }
                            ...
                            if (xidSp == 0
                                ...
                                if (xidSp == 0) {
                                    ...
                                    val translateTypePointTestInjectorMaxXidController =
                                        TranslateTypePointTestInjectorMaxXidController(
                                            application,
    ...
    fun nextMaxXid() {
        ...
        val typePlanTestMaxXidController = TypePlanTestMaxXidController(
            application,
            txtViewMessageProgress,
            btnStartSynchronization,
            progressBarSynchronization,
        ...
        typePlanTestMaxXidController.load()
    }
}