...
import br.com.tecnomotor.marvin.utils.constant.URL.REVISION_PUMP
...
interface RevisionPumpLotXidInterface {
    @Headers("Content-Type:application/octet-stream")
    @GET(CRMANAGER + SEPARATOR + API + SEPARATOR + ANDROID + SEPARATOR + V_1 + SEPARATOR + REVISION_PUMP + SEPARATOR + LOT_XID)
    fun getLotXid(@QueryMap params: Map<String, String>): Call<List<RevisionPumpSynchronize>>
}