...
import br.com.tecnomotor.marvin.utils.constant.URL.SENSOR_PLATFORM
...
interface SensorPlatformLotXidInterface {
    @Headers("Content-Type:application/octet-stream")
    @GET(CRMANAGER + SEPARATOR + API + SEPARATOR + ANDROID + SEPARATOR + V_1 + SEPARATOR + SENSOR_PLATFORM + SEPARATOR + LOT_XID)
    fun getLotXid(@QueryMap params: Map<String, String>): Call<List<SensorPlatformSynchronize>>
}