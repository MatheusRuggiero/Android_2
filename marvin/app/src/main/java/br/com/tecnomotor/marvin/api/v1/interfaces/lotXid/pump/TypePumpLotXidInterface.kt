...
import br.com.tecnomotor.marvin.utils.constant.URL.TYPE_PUMP
...
interface TypePumpLotXidInterface {
    @Headers("Content-Type:application/octet-stream")
    @GET(CRMANAGER + SEPARATOR + API + SEPARATOR + ANDROID + SEPARATOR + V_1 + SEPARATOR + TYPE_PUMP + SEPARATOR + LOT_XID)
    fun getLotXid(@QueryMap params: Map<String, String>): Call<List<TypePumpSynchronize>>
}