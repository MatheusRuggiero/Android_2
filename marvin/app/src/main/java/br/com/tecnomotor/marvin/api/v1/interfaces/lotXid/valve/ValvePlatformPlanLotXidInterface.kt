...
import br.com.tecnomotor.marvin.utils.constant.URL.VALVE_PLATFORM_PLAN
...
interface ValvePlatformPlanLotXidInterface {
    @Headers("Content-Type:application/octet-stream")
    @GET(CRMANAGER + SEPARATOR + API + SEPARATOR + ANDROID + SEPARATOR + V_1 + SEPARATOR + VALVE_PLATFORM_PLAN + SEPARATOR + LOT_XID)
    fun getLotXid(@QueryMap params: Map<String, String>): Call<List<ValvePlatformPlanSynchronize>>
}