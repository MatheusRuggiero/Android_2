...
import br.com.tecnomotor.marvin.api.v1.interfaces.maxXid.injector.TranslateTypePlanTestInjectorMaxXidInterface
...
class TranslateTypePlanTestInjectorMaxXidController(
            ...
            if (txtViewMessageProgress != null) {
                activity?.runOnUiThread {
                    txtViewMessageProgress!!.text =
                        application.applicationContext.getString(R.string.max_xid_translate_type_plan_test_injector)
                    btnStartSynchronization!!.isEnabled = false
                }
                isSynchronizationBackground = false
            }

            val call = BasicAuthClientDefault<TranslateTypePlanTestInjectorMaxXidInterface>(
                mobileUser.userName!!,
                mobileUser.password!!,
                application.applicationContext
            )
                .create(TranslateTypePlanTestInjectorMaxXidInterface::class.java)
                .getMax(params)
                        ...
                        GlobalScope.launch(Dispatchers.IO) {
                            ...
                            if (valuesMaxXid != null
                                ...
                                if (!isSynchronizationBackground) {
                                    GlobalUtil.method.shortTimeMessageAlert(
                                        application.applicationContext,
                                        application.applicationContext.getString(R.string.not_values_translate_type_plan_test_injector_max_xid)
                                    )
                                }
                            }
                            ...
                            if (xidSp == 0
                                ...
                                if (xidSp == 0) {
                                    ...
                                    val translateTypePlanTestInjectorMaxXidController =
                                        TranslateTypePlanTestInjectorMaxXidController(
                                            application,
                                    ...
                                    translateTypePlanTestInjectorMaxXidController.load()
    ...
    fun nextMaxXid() {
        ...
        val translateTypePointTestInjectorMaxXidController = TranslateTypePointTestInjectorMaxXidController(
            application,
            txtViewMessageProgress,
            btnStartSynchronization,
            progressBarSynchronization,
        ...
        translateTypePointTestInjectorMaxXidController.load()
    }
}