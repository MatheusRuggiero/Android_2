...
import br.com.tecnomotor.marvin.utils.constant.URL.TYPE_PLAN_TEST
...
interface TypePlanTestLotXidInterface {
    @Headers("Content-Type:application/octet-stream")
    @GET(CRMANAGER + SEPARATOR + API + SEPARATOR + ANDROID + SEPARATOR + V_1 + SEPARATOR + TYPE_PLAN_TEST + SEPARATOR + LOT_XID)
    fun getLotXid(@QueryMap params: Map<String, String>): Call<List<TypePlanTestSynchronize>>
}