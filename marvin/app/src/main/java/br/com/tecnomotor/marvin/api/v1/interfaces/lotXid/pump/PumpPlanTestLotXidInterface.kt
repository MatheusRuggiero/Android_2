...
import br.com.tecnomotor.marvin.utils.constant.URL.PUMP_PLAN_TEST
...
interface PumpPlanTestLotXidInterface {
    @Headers("Content-Type:application/octet-stream")
    @GET(CRMANAGER + SEPARATOR + API + SEPARATOR + ANDROID + SEPARATOR + V_1 + SEPARATOR + PUMP_PLAN_TEST + SEPARATOR + LOT_XID)
    fun getLotXid(@QueryMap params: Map<String, String>): Call<List<PumpPlanTestSynchronize>>
}