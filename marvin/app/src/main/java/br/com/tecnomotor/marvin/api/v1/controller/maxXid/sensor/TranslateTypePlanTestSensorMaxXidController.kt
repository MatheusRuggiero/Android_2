...
import br.com.tecnomotor.marvin.api.v1.controller.maxXid.valve.RevisionValveMaxXidController
import br.com.tecnomotor.marvin.api.v1.interfaces.maxXid.sensor.TranslateTypePlanTestSensorMaxXidInterface
...
class TranslateTypePlanTestSensorMaxXidController(
            ...
            if (txtViewMessageProgress != null) {
                activity?.runOnUiThread {
                    txtViewMessageProgress!!.text =
                        application.applicationContext.getString(R.string.max_xid_translate_type_plan_test_sensor)
                    btnStartSynchronization!!.isEnabled = false
                }
                isSynchronizationBackground = false
            }

            val call = BasicAuthClientDefault<TranslateTypePlanTestSensorMaxXidInterface>(
                mobileUser.userName!!,
                mobileUser.password!!,
                application.applicationContext
            )
                .create(TranslateTypePlanTestSensorMaxXidInterface::class.java)
                .getMax(params)
                        ...
                        GlobalScope.launch(Dispatchers.IO) {
                            ...
                            if (valuesMaxXid != null
                                ...
                                if (!isSynchronizationBackground) {
                                    GlobalUtil.method.shortTimeMessageAlert(
                                        application.applicationContext,
                                        application.applicationContext.getString(R.string.not_values_translate_type_plan_test_sensor_max_xid)
                                    )
                                }
                            }
                            ...
                            if (xidSp == 0
                                && !GlobalUtil.method.recoverSharedPreferences(
                                    spConfiguration,
                                    PARAMETER_TRANSLATE_TYPE_PLAN_SENSOR_MAX_XID_TRY_AGAIN
                                ).isNullOrEmpty()
                                && !GlobalUtil.method.recoverSharedPreferences(
                                    spConfiguration,
                                    PARAMETER_TRANSLATE_TYPE_PLAN_SENSOR_MAX_XID_TRY_AGAIN
                                ...
                                if (xidSp == 0) {
                                    ...
                                    val translateTypePlanTestSensorMaxXidController =
                                        TranslateTypePlanTestSensorMaxXidController(
                                            application,
                                    ...
                                    translateTypePlanTestSensorMaxXidController.load()
    ...
    fun nextMaxXid() {
        ...
        val revisionValveMaxXidController = RevisionValveMaxXidController(
            application,
            txtViewMessageProgress,
            btnStartSynchronization,
            progressBarSynchronization,
        ...
        revisionValveMaxXidController.load()
