...
import br.com.tecnomotor.marvin.utils.constant.URL.TRANSLATE_PERMISSION_PARAMETER_REMOTE
...
interface TranslateParameterRemoteLotXidInterface {
    @Headers("Content-Type:application/octet-stream")
    @GET(CRMANAGER + SEPARATOR + API + SEPARATOR + ANDROID + SEPARATOR + V_1 + SEPARATOR + TRANSLATE_PERMISSION_PARAMETER_REMOTE + SEPARATOR + LOT_XID)
    fun getLotXid(@QueryMap params: Map<String, String>): Call<List<TranslateParameterRemoteSynchronize>>
}