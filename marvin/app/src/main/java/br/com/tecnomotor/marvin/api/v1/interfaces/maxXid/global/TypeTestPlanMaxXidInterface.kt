package br.com.tecnomotor.marvin.api.v1.interfaces.maxXid.global
...
interface TypeTestPlanMaxXidInterface {
    @Headers("Content-Type:application/octet-stream")
    @GET(CRMANAGER + SEPARATOR + API + SEPARATOR + ANDROID + SEPARATOR + V_1 + SEPARATOR + MAX_XID + SEPARATOR + TYPE_PLAN_TEST)
