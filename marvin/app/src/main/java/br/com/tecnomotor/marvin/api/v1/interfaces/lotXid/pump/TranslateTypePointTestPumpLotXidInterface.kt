...
import br.com.tecnomotor.marvin.utils.constant.URL.TRANSLATE_TYPE_POINT_TEST_PUMP
...
interface TranslateTypePointTestPumpLotXidInterface {
    @Headers("Content-Type:application/octet-stream")
    @GET(CRMANAGER + SEPARATOR + API + SEPARATOR + ANDROID + SEPARATOR + V_1 + SEPARATOR + TRANSLATE_TYPE_POINT_TEST_PUMP + SEPARATOR + LOT_XID)
    fun getLotXid(@QueryMap params: Map<String, String>): Call<List<TranslateTypePointTestPumpSynchronize>>
}