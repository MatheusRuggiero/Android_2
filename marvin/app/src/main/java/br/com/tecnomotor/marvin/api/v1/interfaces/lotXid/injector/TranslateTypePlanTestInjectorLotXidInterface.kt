...
import br.com.tecnomotor.marvin.utils.constant.URL.TRANSLATE_TYPE_PLAN_TEST_INJECTOR
...
interface TranslateTypePlanTestInjectorLotXidInterface {
    @Headers("Content-Type:application/octet-stream")
    @GET(CRMANAGER + SEPARATOR + API + SEPARATOR + ANDROID + SEPARATOR + V_1 + SEPARATOR + TRANSLATE_TYPE_PLAN_TEST_INJECTOR + SEPARATOR + LOT_XID)
    fun getLotXid(@QueryMap params: Map<String, String>): Call<List<TranslateTypePlanTestInjectorSynchronize>>
}