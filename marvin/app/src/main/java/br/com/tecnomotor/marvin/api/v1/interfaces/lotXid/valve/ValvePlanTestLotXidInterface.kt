...
import br.com.tecnomotor.marvin.utils.constant.URL.VALVE_PLAN_TEST
...
interface ValvePlanTestLotXidInterface {
    @Headers("Content-Type:application/octet-stream")
    @GET(CRMANAGER + SEPARATOR + API + SEPARATOR + ANDROID + SEPARATOR + V_1 + SEPARATOR + VALVE_PLAN_TEST + SEPARATOR + LOT_XID)
    fun getLotXid(@QueryMap params: Map<String, String>): Call<List<PlanTestValveSynchronize>>
}