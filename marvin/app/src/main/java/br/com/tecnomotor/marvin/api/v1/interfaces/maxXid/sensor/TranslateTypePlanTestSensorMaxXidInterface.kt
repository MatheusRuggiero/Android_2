package br.com.tecnomotor.marvin.api.v1.interfaces.maxXid.sensor
...
interface TranslateTypePlanTestSensorMaxXidInterface {
    @Headers("Content-Type:application/octet-stream")
    @GET(CRMANAGER + SEPARATOR + API + SEPARATOR + ANDROID + SEPARATOR + V_1 + SEPARATOR + MAX_XID + SEPARATOR + TRANSLATE_TYPE_PLAN_TEST_SENSOR)
