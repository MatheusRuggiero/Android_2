...
@XmlRootElement
class RevisionPumpPlanSynchronize : Serializable {

    @SerializedName("revisaoPlanoBomba")
    @JsonProperty("revisaoPlanoBomba")
    var revisionPlanPump: RevisionPlanPump = RevisionPlanPump()

    @SerializedName("xidRevisionPlanPump")
    @JsonProperty("xidRevisionPlanPump")
    var xidRevisionPlanPump: XidRevisionPlanPump = XidRevisionPlanPump()
}