...
import br.com.tecnomotor.marvin.api.v1.interfaces.maxXid.pump.TranslateTypePointTestPumpMaxXidInterface
...
class TranslateTypePointTestPumpMaxXidController(
            ...
            if (txtViewMessageProgress != null) {
                activity?.runOnUiThread {
                    txtViewMessageProgress!!.text =
                        application.applicationContext.getString(R.string.max_xid_translate_type_point_test_pump)
                    btnStartSynchronization!!.isEnabled = false
                }
                isSynchronizationBackground = false
            }

            val call = BasicAuthClientDefault<TranslateTypePointTestPumpMaxXidInterface>(
                mobileUser.userName!!,
                mobileUser.password!!,
                application.applicationContext
            )
                .create(TranslateTypePointTestPumpMaxXidInterface::class.java)
                .getMax(params)
                        ...
                        GlobalScope.launch(Dispatchers.IO) {
                            ...
                            if (valuesMaxXid != null
                                ...
                                if (!isSynchronizationBackground) {
                                    GlobalUtil.method.shortTimeMessageAlert(
                                        application.applicationContext,
                                        application.applicationContext.getString(R.string.not_values_translate_type_point_test_pump_max_xid)
                                    )
                                }
                            }
                            ...
                            if (xidSp == 0
                                ...
                                if (xidSp == 0) {
                                    ...
                                    val translateTypePointTestPumpMaxXidController =
                                        TranslateTypePointTestPumpMaxXidController(
                                            application,
    ...
    fun nextMaxXid() {
        ...
        val typePointTestPumpMaxXidController = TypePointTestPumpMaxXidController(
            application,
            txtViewMessageProgress,
            btnStartSynchronization,
            progressBarSynchronization,
        ...
        typePointTestPumpMaxXidController.load()
