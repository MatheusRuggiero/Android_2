...
import br.com.tecnomotor.marvin.utils.constant.URL.POINT_TEST_INJECTOR
...
interface PointTestInjectorLotXidInterface {
    @Headers("Content-Type:application/octet-stream")
    @GET(CRMANAGER + SEPARATOR + API + SEPARATOR + ANDROID + SEPARATOR + V_1 + SEPARATOR + POINT_TEST_INJECTOR + SEPARATOR + LOT_XID)
    fun getLotXid(@QueryMap params: Map<String, String>): Call<List<PointTestInjectorSynchronize>>
}