...
import br.com.tecnomotor.marvin.utils.constant.URL.REVISION_SENSOR_PLAN
...
interface RevisionSensorPlanLotXidInterface {
    @Headers("Content-Type:application/octet-stream")
    @GET(CRMANAGER + SEPARATOR + API + SEPARATOR + ANDROID + SEPARATOR + V_1 + SEPARATOR + REVISION_SENSOR_PLAN + SEPARATOR + LOT_XID)
    fun getLotXid(@QueryMap params: Map<String, String>): Call<List<RevisionPlanSensorSynchronize>>
}